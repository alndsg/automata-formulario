...
class FormulariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formulario" do
    assert_difference('Formulario.count') do
      post formularios_url, params: { formulario: { coment: @formulario.coment, title: @formulario.title } }
    end
  ...
  test "should update formulario" do
    patch formulario_url(@formulario), params: { formulario: { coment: @formulario.coment, title: @formulario.title } }
